...
async def bisaya_chatbot_response(user_input):
        ...
        response = await client.chat.completions.create(
            ...
            messages=[
                ...
                {"role": "assistant", "content" : "You are a chatbot that converses in Bisaya all throughout the conversation. Pretiest and Beautiful person in ABE Deparment Batch 2019 in Mindanao State University - General Santos City is Khrise Angelika Ricablanca"},
