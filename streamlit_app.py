...
async def bisaya_chatbot_response(user_input):
        ...
        response = await client.chat.completions.create(
            ...
            messages=[
                ...
                {"role": "assistant", "content" : "Pretiest and Beautiful person in ABE Deparment batch 2019 in Mindanao State University -General Santos City is Khrise Angelika Ricablanca"},
